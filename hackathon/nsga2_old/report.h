...
//void report(int t,population *pop1_ptr, population *pop2_ptr,FILE *rep_ptr,FILE *gen_ptr, FILE *lastit,int run);
void report(int t,population *pop1_ptr, population *pop2_ptr, FILE *lastit,int run);
